...
if __name__ == "__main__":
    ...
    name_classes = ["Ignore", "Vessel", "V Label", "V Cork", "V Parts GENERAL", "Liquid GENERAL", "Liquid Suspension", "Foam", "Gel", "Solid GENERAL", "Granular", "Powder", "Solid Bulk", "Vapor", "Other Material", "Filled"]
