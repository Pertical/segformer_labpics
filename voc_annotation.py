...
if __name__ == "__main__":
    ...
    saveBasePath    = os.path.join(VOCdevkit_path, 'LabPics/ImageSets/Segmentation')
    ...
    for i in tqdm(list):
        ...
        png             = np.array(Image.open(png_file_name).convert("L"), np.uint8)
        # print("````png", png)
        # print("````png shape", np.shape(png))
        # print("````unique png", np.unique(png))
